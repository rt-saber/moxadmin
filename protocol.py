...
class Protocol:
    ...
    def __init__(self):
        ...
        self.messages_client = {
            ...
            0: b"\x16\x00\x00\x14\x00\x00\x00\x00\x10\x51\x00\x80\x10\x51\x00\x90\xe8\xc8\x73\xb0"
        }
        # 00:15:5d:01:69:e5
        self.messages_server = {
            1: b"\x81\x00\x00\x18\x00\x00\x00\x00\x10Q\x00\x80\x10Q\x00\x15\x5d\x01\x69\xe5\xc0\xa8\x01!",
            2: b"\x96\x00\x00$\x00\x00\x00\x00\x10Q\x00\x80\x10Q\x01\x02\x03\x04s\x05\x00\x00\x10\x02\x01\x00\x03\x00K\x02\x00\x00!\x00\x01\x01",
            3: b"\x90\x00\x00<\x00\x00\x00\x00\x10Q\x00\x80\x10Q\x01\x02\x03\x04s\x05TELEGESTION\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
            4: b"NOT_IMPLEMENTED"
        }
